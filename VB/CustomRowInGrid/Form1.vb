...
Namespace GridCustomRows
	Partial Public Class Form1
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            ...
            Dim TempBlankItem1 As BlankItem = New BlankItem(dsw, gridView1, -1, "Only Custom Rows are placed under this Row")
			dsw.CustomRows.Add(New PartContainer(-2, 5, 5, 5))
            Dim TempBlankItem2 As BlankItem = New BlankItem(dsw, gridView1, Integer.MinValue + 1, "The Summary Row calculates only Nested Data Row Values")
			Dim TempSummaryItem As SummaryItem = New SummaryItem(dsw, gridView1, Integer.MinValue)
